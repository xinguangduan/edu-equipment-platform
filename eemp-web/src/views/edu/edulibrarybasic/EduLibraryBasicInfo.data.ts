...
export const formSchema: FormSchema[] = [
  ...
  },
  {
    ...
    dynamicRules: ({model,schema}) => {
          return [
                 { required: true, message: '请输入藏书室面积!'},
          ];
     },
  },
  {
    ...
    dynamicRules: ({model,schema}) => {
          return [
                 { required: true, message: '请输入藏书室藏书架(个)!'},
          ];
     },
  },
  {
    ...
    dynamicRules: ({model,schema}) => {
          return [
                 { required: true, message: '请输入学生阅览室面积!'},
          ];
     },
  },
  {
    ...
    dynamicRules: ({model,schema}) => {
          return [
                 { required: true, message: '请输入学生阅览室阅览桌!'},
          ];
     },
  },
  {
    ...
    dynamicRules: ({model,schema}) => {
          return [
                 { required: true, message: '请输入学生阅览室阅览凳!'},
          ];
     },
  },
  {
    ...
    dynamicRules: ({model,schema}) => {
          return [
                 { required: true, message: '请输入教师阅览室面积!'},
          ];
     },
  },
  {
  ...
  },
  {
    ...
    dynamicRules: ({model,schema}) => {
          return [
                 { required: true, message: '请输入投入金额(万元)!'},
          ];
     },
  },
  {
    ...
    dynamicRules: ({model,schema}) => {
          return [
                 { required: true, message: '请输入管理人员人数!'},
          ];
     },
  },
  {
    ...
    dynamicRules: ({model,schema}) => {
          return [
                 { required: true, message: '请输入管理人员专职!'},
          ];
     },
  },
  {
    ...
    dynamicRules: ({model,schema}) => {
          return [
                 { required: true, message: '请输入管理人员兼职!'},
          ];
     },
  },
	// TODO 主键隐藏字段，目前写死为ID
