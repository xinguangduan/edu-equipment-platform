<template>
  <div>
   ...
   <BasicTable @register="registerTable" :rowSelection="rowSelection">
     <!--插槽:table标题-->
      <template #tableTitle>
        ...
        <a-dropdown v-if="selectedRowKeys.length > 0">
              ...
              <a-button v-auth="'edu.statistics:school_functional_room_info_7:deleteBatch'">批量操作
    ...
    <!-- 表单区域 -->
    <SchoolFunctionalRoomInfo_7Modal @register="registerModal" @success="handleSuccess"></SchoolFunctionalRoomInfo_7Modal>
  </div>
</template>

<script lang="ts" name="org.eemp.modules.edu.statistics-schoolFunctionalRoomInfo_7" setup>
  import {ref, computed, unref, onMounted} from 'vue';
  import {BasicTable, useTable, TableAction} from '/@/components/Table';
  import {useModal} from '/@/components/Modal';
  import { useListPage } from '/@/hooks/system/useListPage'
  import SchoolFunctionalRoomInfo_7Modal from './components/SchoolFunctionalRoomInfo_7Modal.vue'
  import {columns, searchFormSchema} from './SchoolFunctionalRoomInfo_7.data';
  import {list, deleteOne, batchDelete, getImportUrl,getExportUrl, reportOne, batchRevoke, getFillingControlUrl} from './SchoolFunctionalRoomInfo_7.api';
  ...
  async function getFillingControl() {
    let params = {identificationCode: userStore.getUserInfo.telephone, packageName: 'school_functional_room_info_7'};
