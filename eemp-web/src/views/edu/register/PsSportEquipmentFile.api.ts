...
enum Api {
  list = '/org.eemp.modules.edu.register/psSportEquipmentFile/list',
  save='/org.eemp.modules.edu.register/psSportEquipmentFile/add',
  edit='/org.eemp.modules.edu.register/psSportEquipmentFile/edit',
  deleteOne = '/org.eemp.modules.edu.register/psSportEquipmentFile/delete',
  deleteBatch = '/org.eemp.modules.edu.register/psSportEquipmentFile/deleteBatch',
  importExcel = '/org.eemp.modules.edu.register/psSportEquipmentFile/importExcel',
  exportXls = '/org.eemp.modules.edu.register/psSportEquipmentFile/exportXls',
  reportOne = '/org.eemp.modules.edu.register/psSportEquipmentFile/report',
  batchRevoke = '/org.eemp.modules.edu.register/psSportEquipmentFile/revoke',
