...
enum Api {
  list = '/org.eemp.modules.edu.register/jsSportEquipmentFile/list',
  save='/org.eemp.modules.edu.register/jsSportEquipmentFile/add',
  edit='/org.eemp.modules.edu.register/jsSportEquipmentFile/edit',
  deleteOne = '/org.eemp.modules.edu.register/jsSportEquipmentFile/delete',
  deleteBatch = '/org.eemp.modules.edu.register/jsSportEquipmentFile/deleteBatch',
  importExcel = '/org.eemp.modules.edu.register/jsSportEquipmentFile/importExcel',
  exportXls = '/org.eemp.modules.edu.register/jsSportEquipmentFile/exportXls',
  reportOne = '/org.eemp.modules.edu.register/jsSportEquipmentFile/report',
  batchRevoke = '/org.eemp.modules.edu.register/jsSportEquipmentFile/revoke',
