...
export const formSchema: FormSchema[] = [
  ...
  },
  {
    ...
    dynamicRules: ({model,schema}) => {
          return [
                 { required: true, message: '请输入室内操场间数!'},
          ];
     },
  },
  {
    ...
    dynamicRules: ({model,schema}) => {
          return [
                 { required: true, message: '请输入室内操场面积!'},
          ];
     },
  },
  {
  ...
  },
  {
    ...
    dynamicRules: ({model,schema}) => {
          return [
                 { required: true, message: '请输入体育器材室面积!'},
          ];
     },
  },
  {
  ...
  },
  {
    ...
    dynamicRules: ({model,schema}) => {
          return [
                 { required: true, message: '请输入体质测试室面积!'},
          ];
     },
  },
  {
  ...
  },
  {
    ...
    dynamicRules: ({model,schema}) => {
          return [
                 { required: true, message: '请输入心理咨询室面积!'},
          ];
     },
  },
  {
  ...
  },
  {
    ...
    dynamicRules: ({model,schema}) => {
          return [
                 { required: true, message: '请输入音乐教室面积!'},
          ];
     },
  },
  {
  ...
  },
  {
    ...
    dynamicRules: ({model,schema}) => {
          return [
                 { required: true, message: '请输入音乐器材室面积!'},
          ];
     },
  },
  {
  ...
  },
  {
    ...
    dynamicRules: ({model,schema}) => {
          return [
                 { required: true, message: '请输入舞蹈室面积!'},
          ];
     },
  },
  {
    ...
    dynamicRules: ({model,schema}) => {
          return [
                 { required: true, message: '请输入音乐排练室间数!'},
          ];
     },
  },
  {
    ...
    dynamicRules: ({model,schema}) => {
          return [
                 { required: true, message: '请输入音乐排练室面积!'},
          ];
     },
  },
  {
  ...
  },
  {
    ...
    dynamicRules: ({model,schema}) => {
          return [
                 { required: true, message: '请输入美术教室面积!'},
          ];
     },
  },
  {
  ...
  },
  {
    ...
    dynamicRules: ({model,schema}) => {
          return [
                 { required: true, message: '请输入美术器材室面积!'},
          ];
     },
  },
	// TODO 主键隐藏字段，目前写死为ID
