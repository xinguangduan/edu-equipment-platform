...
export const searchFormSchema: FormSchema[] = [
  {
    ...
    componentProps: ({ formActionType }) => {
      ...
      return {
        ...
        code: 'school_list',
        fieldConfig: [{ source: 'school', target: 'school' }],
        multi: false,
      };
    },
...
export const formSchema: FormSchema[] = [
  ...
  },
  {
    ...
    dynamicRules: ({ model, schema }) => {
      return [{ required: true, message: '请输入实验室-面积!' }];
    },
  },
  {
    label: '实验室-间数',
    ...
    component: 'InputNumber',
    dynamicRules: ({ model, schema }) => {
      return [{ required: true, message: '请输入实验室-间数!' }];
    },
  },
  {
    label: '准备室-面积',
    ...
    component: 'InputNumber',
    dynamicRules: ({ model, schema }) => {
      return [{ required: true, message: '请输入准备室-面积!' }];
    },
  },
  {
    label: '准备室-间数',
    ...
    component: 'InputNumber',
    dynamicRules: ({ model, schema }) => {
      return [{ required: true, message: '请输入准备室-间数!' }];
    },
  },
  {
    label: '仪器保管室-面积',
    ...
    component: 'InputNumber',
    dynamicRules: ({ model, schema }) => {
      return [{ required: true, message: '请输入仪器保管室-面积!' }];
    },
  },
  {
    label: '仪器保管室-间数',
    ...
    component: 'InputNumber',
    dynamicRules: ({ model, schema }) => {
      return [{ required: true, message: '请输入仪器保管室-间数!' }];
    },
  },
  {
    label: '实验员-人数',
    ...
    component: 'InputNumber',
    dynamicRules: ({ model, schema }) => {
      return [{ required: true, message: '请输入实验员-人数!' }];
    },
  },
  {
    label: '实验员-专职',
    ...
    component: 'InputNumber',
    dynamicRules: ({ model, schema }) => {
      return [{ required: true, message: '请输入实验员-专职!' }];
    },
  },
  {
    label: '实验员-兼职',
    ...
    component: 'InputNumber',
    dynamicRules: ({ model, schema }) => {
      return [{ required: true, message: '请输入实验员-兼职!' }];
    },
  },
  // TODO 主键隐藏字段，目前写死为ID
  {
