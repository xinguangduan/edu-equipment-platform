...
import org.eemp.modules.quartz.mapper.QuartzJobMapper;
import org.eemp.modules.quartz.service.IQuartzJobService;
import org.quartz.*;
...
public class QuartzJobServiceImpl extends ServiceImpl<QuartzJobMapper, QuartzJob> implements IQuartzJobService {
     ...
     */
    @Override
    @Transactional(rollbackFor = org.eemp.common.exception.JeecgBootException.class)
    ...
    private void schedulerAdd(String id, String jobClassName, String cronExpression, String parameter) {
        try {
            ...
            throw new org.eemp.common.exception.JeecgBootException("创建定时任务失败", e);
        } catch (RuntimeException e) {
            throw new org.eemp.common.exception.JeecgBootException(e.getMessage(), e);
        } catch (Exception e) {
            throw new org.eemp.common.exception.JeecgBootException("后台找不到该类名：" + jobClassName, e);
        }
    }
