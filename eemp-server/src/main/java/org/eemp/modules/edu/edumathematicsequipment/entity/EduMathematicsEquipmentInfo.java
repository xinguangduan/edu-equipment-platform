package org.eemp.modules.edu.edumathematicsequipment.entity;
 ...
 */
@Data
@TableName("edu_mathematics_equipment_info")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="edu_mathematics_equipment_info对象", description="小学数学教学装备配置登记表")
public class EduMathematicsEquipmentInfo implements Serializable {
