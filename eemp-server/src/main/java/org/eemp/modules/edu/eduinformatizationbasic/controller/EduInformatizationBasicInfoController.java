...
@Slf4j
public class EduInformatizationBasicInfoController extends JeecgController<EduInformatizationBasicInfo, IEduInformatizationBasicInfoService> {
	@Autowired
	private IEduInformatizationBasicInfoService eduInformatizationBasicInfoService;
