 ...
 */
@Data
@TableName("ps_scientific_equipment_file")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="ps_scientific_equipment_file对象", description="小学科学教学装备配置文件")
public class PsScientificEquipmentFile implements Serializable {
