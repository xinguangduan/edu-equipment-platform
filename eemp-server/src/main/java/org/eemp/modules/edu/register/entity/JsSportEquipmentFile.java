 ...
 */
@Data
@TableName("js_sport_equipment_file")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="js_sport_equipment_file对象", description="初中体育教学装备配置文件")
public class JsSportEquipmentFile implements Serializable {
