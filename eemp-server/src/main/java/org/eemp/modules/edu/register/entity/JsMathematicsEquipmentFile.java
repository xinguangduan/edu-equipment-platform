 ...
 */
@Data
@TableName("js_mathematics_equipment_file")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="js_mathematics_equipment_file对象", description="初中数学教学装备配置文件")
public class JsMathematicsEquipmentFile implements Serializable {
