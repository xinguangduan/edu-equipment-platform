 ...
 */
@Data
@TableName("signing_of_security_responsibility")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="signing_of_security_responsibility对象", description="安全责任书签订")
public class SigningOfSecurityResponsibility implements Serializable {
