 ...
 */
@Data
@TableName("ps_mathematics_equipment_file")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="ps_mathematics_equipment_file对象", description="小学数学教学装备配置文件")
public class PsMathematicsEquipmentFile implements Serializable {
