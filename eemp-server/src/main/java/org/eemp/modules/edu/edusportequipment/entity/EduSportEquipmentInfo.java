package org.eemp.modules.edu.edusportequipment.entity;
 ...
 */
@Data
@TableName("edu_sport_equipment_info")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="edu_sport_equipment_info对象", description="小学体育教学装备配置登记表")
public class EduSportEquipmentInfo implements Serializable {
