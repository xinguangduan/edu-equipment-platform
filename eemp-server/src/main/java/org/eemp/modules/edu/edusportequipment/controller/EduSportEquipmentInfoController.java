...
@Slf4j
public class EduSportEquipmentInfoController extends JeecgController<EduSportEquipmentInfo, IEduSportEquipmentInfoService> {
	@Autowired
	private IEduSportEquipmentInfoService eduSportEquipmentInfoService;
