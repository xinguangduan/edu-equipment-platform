 ...
 */
@Data
@TableName("js_biology_equipment_file")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="js_biology_equipment_file对象", description="初中生物教学装备配置文件")
public class JsBiologyEquipmentFile implements Serializable {
