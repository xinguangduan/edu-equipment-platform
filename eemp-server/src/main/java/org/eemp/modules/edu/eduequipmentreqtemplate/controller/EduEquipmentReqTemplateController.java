...
@Api(tags="教学器材配备标准模板")
@RestController
@RequestMapping("/eduequipmentreqtemplate/eduEquipmentReqTemplate")
@Slf4j
public class EduEquipmentReqTemplateController extends JeecgController<EduEquipmentReqTemplate, IEduEquipmentReqTemplateService> {
	@Autowired
	...
	public Result<String> add(@RequestBody EduEquipmentReqTemplate eduEquipmentReqTemplate) {
		eduEquipmentReqTemplateService.save(eduEquipmentReqTemplate);
	 ...
	 * @return
	 */
	@AutoLog(value = "教学器材配备标准模板-编辑")
	@ApiOperation(value="教学器材配备标准模板-编辑", notes="教学器材配备标准模板-编辑")
	//@RequiresPermissions("eduequipmentreqtemplate:edu_equipment_req_template:edit")
	@RequestMapping(value = "/edit", method = {RequestMethod.PUT,RequestMethod.POST})
	public Result<String> edit(@RequestBody EduEquipmentReqTemplate eduEquipmentReqTemplate) {
		eduEquipmentReqTemplateService.updateById(eduEquipmentReqTemplate);
