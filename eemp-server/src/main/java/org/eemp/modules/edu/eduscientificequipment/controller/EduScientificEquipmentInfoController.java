...
@Slf4j
public class EduScientificEquipmentInfoController extends JeecgController<EduScientificEquipmentInfo, IEduScientificEquipmentInfoService> {
	@Autowired
	private IEduScientificEquipmentInfoService eduScientificEquipmentInfoService;
