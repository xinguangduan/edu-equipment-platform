 ...
 */
@Data
@TableName("js_music_equipment_file")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="js_music_equipment_file对象", description="初中音乐教学装备配置文件")
public class JsMusicEquipmentFile implements Serializable {
