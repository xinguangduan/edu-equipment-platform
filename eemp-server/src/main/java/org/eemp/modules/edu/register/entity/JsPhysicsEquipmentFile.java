 ...
 */
@Data
@TableName("js_physics_equipment_file")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="js_physics_equipment_file对象", description="初中物理教学装备配置文件")
public class JsPhysicsEquipmentFile implements Serializable {
