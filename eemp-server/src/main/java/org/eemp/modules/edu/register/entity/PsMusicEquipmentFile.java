 ...
 */
@Data
@TableName("ps_music_equipment_file")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="ps_music_equipment_file对象", description="小学音乐教学装备配置文件")
public class PsMusicEquipmentFile implements Serializable {
