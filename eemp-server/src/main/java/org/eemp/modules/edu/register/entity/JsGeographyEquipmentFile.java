 ...
 */
@Data
@TableName("js_geography_equipment_file")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="js_geography_equipment_file对象", description="初中地理教学装备配置文件")
public class JsGeographyEquipmentFile implements Serializable {
