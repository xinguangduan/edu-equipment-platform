 ...
 */
@Data
@TableName("ps_sport_equipment_file")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="ps_sport_equipment_file对象", description="小学体育教学装备配置文件")
public class PsSportEquipmentFile implements Serializable {
