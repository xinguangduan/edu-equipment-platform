...
import org.eemp.modules.system.service.ISysCategoryService;
...
public class SysCategoryServiceImpl extends ServiceImpl<SysCategoryMapper, SysCategory> implements ISysCategoryService {
    ...
    @Override
    public List<TreeSelectModel> queryListByCode(String pcode) throws org.eemp.common.exception.JeecgBootException {
        ...
        if (oConvertUtils.isNotEmpty(pcode)) {
            ...
            if (list == null || list.size() == 0) {
                throw new org.eemp.common.exception.JeecgBootException("该编码【" + pcode + "】不存在，请核实!");
            }
            if (list.size() > 1) {
