...
import org.eemp.modules.system.mapper.SysDepartPermissionMapper;
import org.eemp.modules.system.mapper.SysDepartRolePermissionMapper;
import org.eemp.modules.system.mapper.SysPermissionMapper;
...
public class SysPermissionServiceImpl extends ServiceImpl<SysPermissionMapper, SysPermission> implements ISysPermissionService {
    ...
    public void deletePermission(String id) throws org.eemp.common.exception.JeecgBootException {
        SysPermission sysPermission = this.getById(id);
        if (sysPermission == null) {
            throw new org.eemp.common.exception.JeecgBootException("未找到菜单信息");
        }
    ...
    public void deletePermissionLogical(String id) throws org.eemp.common.exception.JeecgBootException {
        SysPermission sysPermission = this.getById(id);
        if (sysPermission == null) {
            throw new org.eemp.common.exception.JeecgBootException("未找到菜单信息");
        }
    ...
    @Override
    @CacheEvict(value = CacheConstant.SYS_DATA_PERMISSIONS_CACHE, allEntries = true)
    public void addPermission(SysPermission sysPermission) throws org.eemp.common.exception.JeecgBootException {
        //----------------------------------------------------------------------
        //判断是否是一级菜单，是的话清空父菜单
    ...
    @Override
    @CacheEvict(value = CacheConstant.SYS_DATA_PERMISSIONS_CACHE, allEntries = true)
    public void editPermission(SysPermission sysPermission) throws org.eemp.common.exception.JeecgBootException {
