...
import org.eemp.common.util.RestUtil;
...
public class JeecgElasticsearchTemplate {
    ...
    public JeecgElasticsearchTemplate(@Value("${eemp.elasticsearch.cluster-nodes}") String baseUrl, @Value("${eemp.elasticsearch.check-enabled}") boolean checkEnabled) {
