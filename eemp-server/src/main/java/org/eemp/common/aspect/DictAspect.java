...
public class DictAspect {
     ...
     * 定义切点Pointcut
     */
//    @Pointcut("execution(public * org.jeecg.modules..*.*Controller.*(..)) || @annotation(org.eemp.common.aspect.annotation.AutoDict)")
    @Pointcut("execution(public * org.eemp.modules..*.*Controller.*(..)))")
