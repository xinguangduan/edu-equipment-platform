 ...
 */
package org.eemp.common.poi.excel.imports;
...
import org.eemp.common.poi.excel.entity.params.ExcelCollectionParams;
import org.eemp.common.poi.excel.entity.params.ExcelImportEntity;
import org.eemp.common.poi.excel.entity.result.ExcelImportResult;
import org.eemp.common.poi.excel.entity.result.ExcelVerifyHanlderResult;
import org.eemp.common.poi.excel.imports.base.ImportBaseService;
import org.eemp.common.poi.excel.imports.base.ImportFileServiceI;
import org.eemp.common.poi.excel.imports.verifys.VerifyHandlerServer;
import org.eemp.common.poi.exception.excel.ExcelImportException;
import org.eemp.common.poi.exception.excel.enums.ExcelImportEnum;
import org.eemp.common.poi.util.ExcelUtil;
...
public class ExcelImportServer extends ImportBaseService {
    ...
    private <T> List<T> importExcelSportTemplate(Collection<T> result, Sheet sheet, Class<?> pojoClass, ImportParams params, Map<String, PictureData> pictures) throws Exception {
        List collection = new ArrayList();
...
//		}
     ...
     * @throws Exception
     */
    public ExcelImportResult importExcelSportTemplateByIs(InputStream inputstream, Class<?> pojoClass, ImportParams params) throws Exception {
        if (LOGGER.isDebugEnabled()) {
            LOGGER.debug("Excel import start ,class is {}", pojoClass);
        }
        List<T> result = new ArrayList<T>();
...
//		}
        ...
        for (int i = params.getStartSheetIndex(); i < params.getStartSheetIndex()
            ...
            result.addAll(importExcelSportTemplate(result, book.getSheetAt(i), pojoClass, params, pictures));
            if (LOGGER.isDebugEnabled()) {
                LOGGER.debug(" end to read excel list by pos ,endTime is {}", new Date().getTime());
            }
        }
