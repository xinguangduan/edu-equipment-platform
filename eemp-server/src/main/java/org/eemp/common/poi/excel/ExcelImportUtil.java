 ...
 */
package org.eemp.common.poi.excel;
...
import org.eemp.common.poi.excel.imports.ExcelImportServer;
import org.eemp.common.poi.excel.imports.sax.SaxReadExcel;
import org.eemp.common.poi.excel.imports.sax.parse.ISaxRowRead;
import org.eemp.common.poi.handler.inter.IExcelReadRowHanlder;
...
public final class ExcelImportUtil {
	 ...
	 * @throws Exception
	 */
	public static <T> List<T> importExcelSportTemplate(InputStream inputstream, Class<?> pojoClass, ImportParams params) throws Exception {
		return new ExcelImportServer().importExcelSportTemplateByIs(inputstream, pojoClass, params).getList();
	}
