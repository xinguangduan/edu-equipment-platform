...
INSERT INTO filling_control (id, control_type, filling_code, control_name, start_date, end_date) VALUES
  ('101', '01', '2022-02', '2022学年下学期', {ts '2023-02-16'}, {ts '2023-03-31'}),
  ('102', '01', '2023-01', '2023学年上学期', {ts '2023-09-01'}, {ts '2023-10-31'});
